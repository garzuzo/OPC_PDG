    ...
    <div class="init">
      <v-container class="fill-height" style="min-height: 100%">
        ...
        <v-row style="padding-top: 20vh; padding-bottom:20vh;">
          <v-col cols="8">
               <p style="padding-bottom:5vh;">Estamos comprometidos con los datos abiertos </p>
       
             </v-col>
             <v-col cols=3>
            <img style="height:400px" :src="require(`@/assets/data.jpg`)" class="img" />
             </v-col>
        </v-row>
      </v-container>
    </div>
    ...
    data(){
        return{
            ...
            headers:[
                ...
                {text:"Comuna_corregimiento_actual", value:'Comuna_corregimiento_actual'},
                ...
                {text:"Comuna_corregimiento_origen", value:'Comuna_corregimiento_origen'},
