# Generated by Django 2.2.4 on 2019-10-26 00:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neightborhoodVeredaActual', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='personterritoryactual', to='opcapp.NeightborhoodVereda')),
                ('neightborhoodVeredaSource', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='personterritorysource', to='opcapp.NeightborhoodVereda')),
            ],
        ),
        migrations.CreateModel(
            name='RoleCampaign',
